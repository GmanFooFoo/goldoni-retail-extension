...
| 3 | Los-Kennzeichnung / Chargennummer nach LKV fehlt — separate Pflicht neben dem MHD, Entlastungs-Regel (MHD mit Tag+Monat ersetzt Los) nur bei einem Produkt pro Tag tragfähig. | P1 | S | Lebensmittelrechtler (Format) + Küche (Prozess-Ankerung) | Ja, vor erstem Verkauf | Offen | Kopplung an Doc 05 HACCP-Eingangsprotokolle; Rückruf nach Finding 3 Doc 05 setzt eindeutige Los-Identifikation voraus. |
...
| 5 | Hersteller-Anschrift unvollständig — "Reinsburgstraße, Stuttgart" ohne Hausnummer und PLZ; Art. 9 Abs. 1 lit. h LMIV fordert die vollständige Anschrift. | P1 | XS | Silvio | Ja, vor erstem Etikett-Druck | Offen | [TBD-Silvio] Rule 8; echte Adresse bestätigen. |
...
| 9 | PPWR (VO EU 2025/40) ab 12. August 2026 nicht adressiert — Konformitätserklärung pro Verpackung, Piktogramm-Kennzeichnung, PFAS-Grenzwerte für Lebensmittelkontakt-Verpackungen. | P2 | S | Lebensmittelrechtler + Silvio (Beutel-Lieferant anfragen) | Ja, wenn Launch nach 12.8.2026 | Offen | Für PA/PE-Vakuumbeutel sind PFAS unkritisch, aber die Konformitätserklärung ist universell. Datums-Marker im Rollout-Plan zwingend. |
...
**Gruppe A — Silvio-Aktionen:** Findings 5 (vollständige Hersteller-Anschrift bestätigen — [TBD-Silvio] Rule 8), 7 (Labor-Beauftragung für Nährwert-Analyse pro Produktlinie, 320–600 €), 9 (Beutel-Lieferant nach PPWR-Konformitätserklärung und PFAS-Nachweis fragen). Alle drei asynchron, nicht-session-gebunden. Ziehen in das bestehende **Silvio-Paket**, das nach Session 5 aus drei Anruf-Blöcken besteht (Vetamt/IHK, Steuerberater/Kasse/Gewerbeamt, IfSG/Schädlinge/HACCP-Benennung). Mit Doc 04 wächst es um einen vierten Block: **Etikett-Vorbereitung** (Adresse, Labor, Beutel-Lieferant). Finding 1 (Primärzutat-Herkunft) hängt an den Lieferanten-Daten aus Doc 11 und ist daher ein hybrides A/B-Finding — Silvios Lieferanten-Liste plus Claudes Dokumentations-Arbeit.
