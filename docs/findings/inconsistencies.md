...
Werden in Stufe 3 (Deep Review) von den jeweiligen Rollen validiert. Einträge 1 und 3 wurden in Session 3 erweitert, nachdem der neue Rollout-Plan (`docs/plans/rollout-plan.md`, Gate-basiert, 10–12 Wochen) und D-02 (Phase 1 = nur Vakuum gekühlt) in Kraft traten. Eintrag 6 ist aus dem Spot-Check, Eintrag 7 aus dem Doc-03-Lead-Review (Session 4) und wurde in Session 6 um Doc 04 erweitert, Einträge 5 (Präzisierung) und 8 aus dem Doc-15-Lead-Review (Session 5), Einträge 9 und 10 aus dem Doc-04-Lead-Review (Session 6).
...
| 7 | **MHD-Validierung + Los-Kennzeichnung:** Doc 03 sagt "Fachliteratur oder eigene Tests" — ohne Protokoll. Doc 05 listet konkrete MHD-Werte (Lasagne 7 Tage, Ragù 8 Tage) als Schätzung, nicht validiert. Doc 04 (LMIV) nennt das MHD in der Pflichtangaben-Tabelle, übergeht aber die separate Los-Kennzeichnung nach LKV komplett (Entlastungs-Regel "MHD-Tag ersetzt Los" trägt nicht bei mehreren Produkten am selben Tag). Listeria-Risiko bei Béchamel + Vakuum + Kühlung. Haftungs-Quelle nach § 58 LFGB. | Doc 03, 04, 05 | Persona-Red-Flag Lebensmittelrechtler, [Finding 3 Doc 03](03-findings.md#findings-tabelle), [Finding 2 Doc 05](05-findings.md#findings-tabelle), [Finding 3 Doc 04](04-findings.md#findings-tabelle) | Lebensmittelrechtler + Küche (Test-Protokoll und Los-Format) oder akkreditiertes Labor |
