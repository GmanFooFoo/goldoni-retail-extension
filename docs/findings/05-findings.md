...
| 3 | Rückruf-Prozess fehlt (Art. 19 VO 178/2002). | P1 | S | Lebensmittelrechtler + Silvio (Benennung) | Ja, vor erstem Verkauf | Offen | Cross-Ref Doc 03 Finding 1; Schreibort offen (Doc 05 oder Doc 14, Entscheidung beim Doc-14-Review). |
...
| 12 | IfSG § 43 Erstbelehrung und jährliche Folgebelehrung fehlen im Schulungs-Abschnitt. | P2 | XS | Lebensmittelrechtler + Silvio (Termin Gesundheitsamt) | Ja, vor erstem Verkauf für Personal, das am Vakuum arbeitet | Offen | Ohne Belehrung kein Einsatz am Vakuum zulässig; formaler Stopp-Grund. |
...
| 14 | Schädlingsbekämpfungsplan fehlt oder Cross-Ref zum bestehenden Restaurant-Plan mit Retail-Erweiterung. | P3 | XS | Lebensmittelrechtler + Silvio (Bestand klären) | — | Offen | Standard-Vetamt-Prüfpunkt; meist mit Frist behoben, kein Launch-Blocker. |
| 15 | HACCP-Beauftragter nicht namentlich benannt (Art. 5 VO 852/2004). | P3 | XS | Silvio (Selbstbenennung) | — | Offen | Cross-Ref Doc 03 Finding 2; trivial, aber dokumentieren vor Einreichung. |
...
**Gruppe A — Silvio-Aktionen:** Findings 12 (Termin Gesundheitsamt § 43 IfSG für sich und das Personal, das am Vakuum arbeiten wird), 14 (Bestand Schädlingsbekämpfungsvertrag klären, ggf. erweitern), 15 (Selbstbenennung HACCP-Beauftragter). Alle drei asynchron, nicht-session-gebunden. Ziehen in das bestehende **Silvio-Paket**, das aus Doc 03 Gruppe A (Vetamt/IHK) und Doc 15 Gruppe A (Steuerberater/Kasse/Gewerbeamt) entstanden ist. Das Silvio-Paket wächst damit auf drei Anruf-Blöcke plus drei Selbstbenennungen/Termine.
