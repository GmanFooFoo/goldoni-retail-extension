...
| 3 | Gewerbeanzeige nach § 14 GewO nicht adressiert. Retail ist Einzelhandel mit Lebensmitteln, nicht Gaststättenerlaubnis. Gewerbeamt-Anzeige → Silvio-Paket SP-03. | P1 | XS | Steuerberaterin (Doc-Ergänzung) | Pflicht vor erstem Verkauf | Offen | Ohne Erweiterung läuft der Retail-Umsatz ordnungsrechtlich nicht sauber; Risiko Bußgeld und Umsatzsperre. |
| 4 | KassenSichV / TSE-Pflicht nicht geprüft. Kann Silvios Kasse zwei Steuersätze nebeneinander und ist sie TSE-zertifiziert? Kassen-Check → Silvio-Paket SP-06. | P1 | XS | Steuerberaterin (Auswertung nach Rückmeldung) | Ja, bei "Nein" Stopp bis System-Update | Offen | Bei Kassen-Nachschau hart geprüft; fehlende TSE ist Bußgeld-bewehrt. |
| 5 | Trennung Erlöskonten nicht operationalisiert. Kein Anker im Kontenrahmen (SKR 03 / SKR 04). Teil des Steuerberater-Briefings → Silvio-Paket SP-05. | P2 | S | Steuerberaterin (nach Rückmeldung) | — | Offen | Ohne saubere Trennung Jahresabschluss nicht nachvollziehbar; Betriebsprüfungs-Risiko. |
...
| 8 | Abschreibung Vakuumierer nicht konkret durchgerechnet. Anschaffungswert, Vorsteuer, AfA-Nutzungsdauer, jährliche AfA fehlen. Teil des Steuerberater-Briefings → Silvio-Paket SP-05. | P2 | XS | Steuerberaterin (Rechenbeispiel) | — | Offen | Vorsteuer aus Vakuumierer-Kauf (285–665 €) ist Liquidität, die im Rollout-Plan-Budget nicht gegengerechnet ist. |
...
| 14 | Fixkosten-Allokation Retail-Strang fehlt — ohne anteiligen Overhead (Miete, Strom, Kühlschrank, Küchen-Abschreibung) sieht jede variable Kalkulation profitabel aus. Muss als Methodik-Entscheidung in Doc 02 verankert werden (Vollkosten vs. Teilkosten). | P2 | S | CFO (Doc-02-Lead-Review) | — | Offen | Ohne Allokation subventioniert das Restaurant den Retail-Strang verdeckt — die betriebswirtschaftliche Antwort "lohnt sich Retail?" ist dann nicht beantwortbar. |
| 15 | Gewerbesteuer-Effekt nicht modelliert — bei Hebesatz 420 % Stuttgart und 10–15k Retail-Gewinn ca. 550–825 € zusätzlich. Muss in Doc 02 Wirtschaftlichkeit und Doc 18 Finanzierungsplan. | P3 | XS | CFO (Doc-02-Lead-Review) | — | Offen | Kein Stopper, aber ein Posten in der Wirtschaftlichkeitsrechnung; beeinflusst Gewerbesteuer-Vorauszahlung. |
| 16 | Kassensystem-worst-case-Kosten (Nachrüstung TSE 300–500 €, Komplett-Ersatz 1.500–3.000 €) nicht als Budgetposition in Doc 12 geführt. Abhängig von SP-06-Ergebnis. | P2 | XS | CFO (Doc-12-Lead-Review) | SP-06 (Kassen-Check) | Offen | Wenn Kasse nicht TSE-fähig: Stopper für Rollout, plus ungeplanter Capex-Block. |
