# Findings — Doc 09 Verkaufsstrategie
...
|---|---|---|---|---|---|
| 1 | **Wolt/Uber als Vertriebskanal fehlt komplett.** D-13 macht Plattform-Lieferung zum Phase-1-Kanal. Listing, Provisions-Kalkulation, Preis-Strategie nötig. | P1 | Jana F-01 | v2-Rewrite | Offen |
| 2 | **Webshop in Phase 3 statt Phase 1.** D-12: Webshop + Stripe ab Phase 1 für Vorbestellungen. | P1 | Jana F-02 | v2-Rewrite (Phasen-Korrektur) | Offen |
| 3 | **Nur 2 Produkte statt 5.** Kellner-Skript, Abo-Box, Instagram-Content — alles nur Lasagne + Ragù. | P1 | Jana F-03 | v2-Rewrite | Offen |
| 4 | **Abo-Box Preise und Produkte veraltet.** VK-Preise weichen von Doc 02 v2 ab. 5-Produkt-Rotation fehlt. | P2 | Jana F-04 | v2-Rewrite (Propagation Doc 02 v2) | Offen |
| 5 | **Kellner-Skript existiert nicht.** "Kellner-Skript schreiben" als Prio 1, aber kein konkreter Text. | P2 | Jana F-05 | v2-Rewrite | Offen |
